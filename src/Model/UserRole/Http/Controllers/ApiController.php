...
use Ohio\Core\Model\UserRole\Domain\Criteria\UserRolePaginateCriteria;
...
class ApiController extends BaseApiController
{
    ...
    /**
     * @var Domain\UserRoleRepository
     */
    protected $repository;

    /**
     * @var Domain\UserRoleValidator
     */
    protected $validator;


    public function __construct(Domain\UserRoleRepository $repository, Domain\UserRoleValidator $validator)
    {
