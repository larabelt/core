...
class OhioCoreServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        include __DIR__ . '/Model/User/Http/routes.php';
        include __DIR__ . '/Model/Role/Http/routes.php';
        include __DIR__ . '/Model/UserRole/Http/routes.php';
    ...
    public function boot(GateContract $gate, Router $router)
    {
        ...
        View::composer(['layout::admin.partials.scripts-body-close'], Ohio\Core\Base\Composer\NgComposer::class);
    ...
    public function registerPolicies(GateContract $gate)
    {
        ...
        $this->app->singleton(Ohio\Core\Base\Service\NgService::class);
    }
