...
import ParamKeyTable from 'belt/core/js/param-keys/table';
import ParamValaueTable from 'belt/core/js/param-values/table';
import shared from 'belt/core/js/paramables/ctlr/shared';
import html from 'belt/core/js/paramables/templates/create.html';
