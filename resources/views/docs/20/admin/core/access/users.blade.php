...
@include('belt-docs::partials.iframe', ['src' => '/docs/preview/core/2.0/admin/screen?content=manager.users&style=content'])
...
@include('belt-docs::partials.iframe', ['src' => '/docs/preview/core/2.0/admin/screen?content=editor.users&style=content'])
