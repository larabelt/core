...
@include('belt-core::docs.partials.table', [
    'rows' => [
        ...
        ['Save Button​​', 'Commits the data to the database and is made available immediately. ​(Note: Upon initial save, additional attribute tabs will be made available.)'],
    ],
])
