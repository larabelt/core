        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="/admin/ohio-cms/admin/#!/users/index"><i class="fa fa-users"></i> <span>Users 2</span></a></li>
                    <li><a href="/admin/ohio-cms/admin/#!/roles/index"><i class="fa fa-users"></i> <span>Roles 2</span></a></li>
                </ul>
            </li>
