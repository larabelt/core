...
use Ohio\Core\User\Http\Controllers\Api\RolesController;
...
class RolesControllerTest extends Testing\OhioTestCase
{
    ...
    /**
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::__construct
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::user
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::role
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::show
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::destroy
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::store
     * @covers \Ohio\Core\User\Http\Controllers\Api\RolesController::index
     */
    public function test()
    {
        ...
        # construct
        $controller = new RolesController($userRepository, $roleRepository);
        ...
        $controller = m::mock(RolesController::class . '[paginator]', [$userRepository, $roleRepository]);
        $controller->shouldReceive('paginator')->andReturn($paginatorMock);
        $response = $controller->index(new PaginateRoles(), 1);
        $this->assertEquals(200, $response->getStatusCode());
    }
