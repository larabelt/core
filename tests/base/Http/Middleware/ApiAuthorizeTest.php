...
use Ohio\Core\Base\Http\Middleware\ApiAuthorize;
...
class ApiAuthorizeTest extends OhioTestCase
{
    ...
    /**
     * @covers \Ohio\Core\Base\Http\Middleware\ApiAuthorize::__construct()
     * @covers \Ohio\Core\Base\Http\Middleware\ApiAuthorize::handle()
     */
